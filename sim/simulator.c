/**
 * @file simulator.c
 * @brief Desktop simulator for delta CNC trajectories.
 */
...
{
    vec3_q16 pts[4];
    pts[0] = vec3_from_float(-50.0f, 0.0f, 0.0f);
    pts[1] = vec3_from_float(0.0f, 50.0f, 0.0f);
    pts[2] = vec3_from_float(50.0f, 0.0f, 0.0f);
    pts[3] = vec3_from_float(0.0f, -50.0f, 0.0f);
    spl_plan_t plan;
...
int main(int argc, char **argv)
{
    ...
    printf("Simulator output written to sim_output.ppm and sim_output.csv\n");
    return 0;
}
